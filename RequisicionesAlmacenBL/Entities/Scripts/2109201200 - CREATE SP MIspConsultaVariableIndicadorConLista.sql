...
/* ****************************************************************
 * MIspRptLibroConsultaVariableIndicador
 * ****************************************************************
 * Descripción: Consulta para obtener el reporte de Varables de los Indicadores con la lista.
 * Autor: Rene Carrillo
 * Fecha: 20.09.2021
 * Versión: 1.0.0
 *****************************************************************
...
CREATE   PROCEDURE [dbo].[MIspConsultaVariableIndicadorConLista]
	@MIRId INT
AS
	...
	SELECT vi.MIRIndicadorId, vi.Orden, vi.Nombre, vi.ResumenNarrativo, vi.NombreIndicador, vi.Formula, vi.FrecuenciaMedicion, vi.UnidadMedida FROM @ListaVariableIndicdor vi GROUP BY vi.MIRIndicadorId, vi.Orden, vi.Nombre, vi.ResumenNarrativo, vi.NombreIndicador, vi.Formula, vi.FrecuenciaMedicion, vi.UnidadMedida ORDER BY vi.Orden ASC
