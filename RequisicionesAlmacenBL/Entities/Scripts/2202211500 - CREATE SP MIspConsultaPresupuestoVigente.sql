		...
		BEGIN
			...
			ELSE
				BEGIN
					...
					INSERT INTO @ListaDetalle(ConfiguracionPresupuestoDetalleId, ConfiguracionPresupuestoId, ClasificadorId, MIRIndicadorId, MIRIndicadorComponenteId, Enero, Febrero, Marzo, Abril, Mayo, Junio, Julio, Agosto, Septiembre, Octubre, Noviembre, Diciembre, Anual, Porcentaje, EstatusId, Componente, Actividad, EsProyecto, MontoIndicador, MontoProyecto)
						VALUES(@ContadorRegistrosNuevos, @ConfiguracionPresupuestoId, 56, @MIRIndicadorId_, @MIRIndicadorId, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, @Porcentaje, 1, @Componente, @Actividad, @EsProyecto, @MontoIndicador, @MontoProyecto)
