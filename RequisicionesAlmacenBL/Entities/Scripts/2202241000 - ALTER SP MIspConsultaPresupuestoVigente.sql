...
AS
	...
	BEGIN
		...
		-- Verificar si los indicadores ha modificado que no estar de acuerdo de ponderacion (editado)
		SELECT TOP 1 @EsEditado = d.EsEditado, @EsProyecto = d.EsProyecto, @MontoProyecto = d.MontoProyecto, @TotalPorcentaje = d.TotalPorcentaje FROM @ListaDetalle d WHERE d.MIRIndicadorComponenteId = @MIRIndicadorId;
