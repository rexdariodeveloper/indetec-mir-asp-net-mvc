...
var editar = function (event) {
    window.location.href = API_FICHA + "editar/" + event.row.data.InvitacionCompraId;
}

var ver = function (event) {
    window.location.href = API_FICHA + "ver/" + event.row.data.InvitacionCompraId;
}
...
var eliminaRegistro = function () {
    ...
    $.ajax({
        ...
        data: { invitacionCompraId: rowEliminar.InvitacionCompraId, timestamp: rowEliminar.Timestamp },
